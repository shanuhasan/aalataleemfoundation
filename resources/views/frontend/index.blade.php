                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="slider_text ">
                            ...
                            {{-- <h3>Help the children for their bright future</h3> --}}
                            {{-- <p>With so much to consume and such little time, coming up <br>
                                with relevant title ideas is essential</p> --}}
                            {{-- <a href="javascript:void(0);" class="boxed-btn3">Learn More --}}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                                <img src="{{ asset('assets/frontend/images/help/1.png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                                <img src="{{ asset('assets/frontend/images/help/2.png') }}" alt="">
                            </div>
                        </div>
                        <div class="help_content">
                            <h4>Blood Camp</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_reson">
                        <div class="thum">
                            <div class="thum_1">
                                <img src="{{ asset('assets/frontend/images/help/3.png') }}" alt="">
                            </div>
                        </div>
                        <div class="help_content">
                ...
                <div class="col-lg-12">
                    <div class="causes_active owl-carousel">
                        <div class="single_cause">
                            <div class="thumb">
                                <img src="{{ asset('assets/frontend/images/causes/1.png') }}" alt="">
                            </div>
                        ...
                        <div class="single_cause">
                            <div class="thumb">
                                <img src="{{ asset('assets/frontend/images/causes/2.png') }}" alt="">
                            </div>
                            <div class="causes_content">
                                <div class="custom_progress_bar">
                                    <div class="progress">
                        ...
                        <div class="single_cause">
                            <div class="thumb">
                                <img src="{{ asset('assets/frontend/images/causes/3.png') }}" alt="">
                            </div>
                            <div class="causes_content">
                                <div class="custom_progress_bar">
                                    <div class="progress">
